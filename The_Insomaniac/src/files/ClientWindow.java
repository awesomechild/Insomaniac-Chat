...
//com.jtattoo.plaf.aluminium.AluminiumLookAndFeel  --light
...
public class ClientWindow extends JFrame implements Runnable {
	...
	private void createWindow() {
		...
		txtMessage.setRequestFocusEnabled(true);
	}
	...
	private void send(String message, boolean text) {
		...
		if (text) {
			...
			message = "/m/" + message + "/e/";
			// appending /m/ to the starting of the message
			txtMessage.setText("");
		}
			...
			public void run() {
				while (running) {
					...
					if (message.startsWith("/c/")) {
						...
						// bec message is of the form /c/msg/e/
